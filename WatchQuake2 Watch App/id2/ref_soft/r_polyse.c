...
//#endif
    ...
    //d_pdest = (byte *)d_viewbuffer + ystart * vid_width + plefttop[0];
    //d_pz = d_pzbuffer + ystart * vid_width + plefttop[0];
...
//#else
...
#endif
		{
            ...
            //d_pzbasestep = vid_width + ubasestep;
			d_pzextrastep = d_pzbasestep + 1;
		}
//#endif

		d_pdestbasestep = r_screenwidth + ubasestep;
        //d_pdestbasestep = vid_width + ubasestep;
