...
#define SNDCALL_FLAG_ORIGIN 0x01
// S_StartSound vec3_t origin, int entnum, int entchannel, struct sfx_s *sfx, float fvol, float attenuation, float timeofs
...
#define	MAX_RAW_SAMPLES	(8192*2) //8192
...
extern cvar_t *bgm_volume;
extern cvar_t *cin_volume;
